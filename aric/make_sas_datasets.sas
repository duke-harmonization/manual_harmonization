...
libname here "/data/aric/dbgap/import_pheno_text/metadata";

**** READ THE DIRECTORY FILENAMES INTO A DATASET;
filename dirlist pipe "dir -B /data/aric/dbgap/phenotype_files";
...
filename sfile "/data/aric/dbgap/phenotype_files/%scan(&fnames,&i,'|')";
filename SXLEMAP "./aric.map";
