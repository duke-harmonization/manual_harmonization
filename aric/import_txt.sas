/* -----------------------------------------------------------------------------------------------
   ...
   Protocol   :
   Purpose    : Import ARIC dbGaP 61083 text files, rename variables, and combine with
...
libname inlbl '/data/aric/dbgap/import_pheno_text/metadata' access=readonly;
libname out '/data/aric/dbgap/import_pheno_text/outdata';
...
filename dirlist pipe "ls /data/aric/dbgap/import_pheno_text/metadata";
...
filename dirlist2 pipe "ls /data/aric/dbgap/import_pheno_text/text";
...
proc import datafile="/data/aric/dbgap/import_pheno_text/text/%scan(&txtnames,&j,"|")"
            out=impvars
            dbms=dlm
            replace;
     datarow=11;
...
data impvars;
 ...
 rename __Study_accession__phs000280_v7_ = VAR1;
...
/**************************************************************************************************************/
/* The data set IMPVARS contains one observation, and the variables contained in the data are VAR1-VARn.      */
